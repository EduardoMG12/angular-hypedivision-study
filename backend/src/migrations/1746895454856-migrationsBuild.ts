...
export class MigrationsBuild1746895454856 implements MigrationInterface {
    name = 'MigrationsBuild1746895454856'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "card_tags" ADD CONSTRAINT "FK_3ec63f6e6de1603047cb3d1d1be" FOREIGN KEY ("cardId") REFERENCES "cards"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
