...
export class MigrationsBuild1746811179902 implements MigrationInterface {
    name = 'MigrationsBuild1746811179902'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cards" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "type" character varying(20) NOT NULL DEFAULT 'flip', "title" character varying(255), "description" character varying(255), "status" character varying(20) NOT NULL DEFAULT 'active', "owner_id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP DEFAULT now(), "ownerId" uuid NOT NULL, CONSTRAINT "PK_5f3269634705fdff4a9935860fc" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "cards" ADD CONSTRAINT "FK_e9078cd97ce72a08eaf8503fb30" FOREIGN KEY ("ownerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "cards" DROP CONSTRAINT "FK_e9078cd97ce72a08eaf8503fb30"`);
