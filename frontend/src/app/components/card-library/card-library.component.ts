...
import { EmptyCardLibraryComponent } from "../../components/card-library/components/empty-card-library/empty-card-library.component";

import { FormularyCreateCardComponent } from "../../components/card-library/components/formulary-create-card/formulary-create-card.component";
...
import { CardListComponent } from "../../components/card-library/components/card-list/card-list.component";
...
@Component({
	...
	styleUrl: "./card-library.component.css",
	animations: [
